...
python $DIR/codegen.py 'body'   $DIR/rabbitmq_codegen/amqp-rabbitmq-0.9.1.json $DIR/../Sources/Spec/Spec+AMQPCodable.swift
# tests
...
# format
swift format format --in-place --configuration $DIR/../.swift-format $DIR/../Sources/Spec/Spec.swift $DIR/../Sources/Spec/Spec+AMQPCodable.swift $DIR/../Tests/AMQPTests/Spec/CodableRoundtrip.swift $DIR/../Tests/AMQPTests/Spec/CodableVerification.swift
